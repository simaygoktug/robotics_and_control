...
def run_silently(track_layout, driving_agent, max_steps=1000, deltaT=1/50):
    ...
    for step in range(max_steps):
        ...
        a_=driving_agent.agent_position
        b_=driving_agent.agent_orientation 
        ...
        assert a_==driving_agent.agent_position, "Your driving decision must not directly change the car location/orientation"
        assert b_==driving_agent.agent_orientation, "Your driving decision must not directly change the car location/orientation"        
